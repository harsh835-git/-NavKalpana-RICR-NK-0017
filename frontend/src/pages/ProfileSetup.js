        ...
        <div className="card profile-setup-card" style={{ borderRadius: 20, padding: 32 }}>
          ...
          {step === LAST_STEP && (
            <div style={{
              ...
              borderRadius: 10, padding: '11px 14px', marginTop: 20,
              fontSize: 12, color: 'var(--text2)', lineHeight: 1.6
            }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffb340" strokeWidth="2.2"
              ...
              <span>
                ...
                Plans generated are for general informational purposes and not a substitute for professional medical advice.
                Please consult a qualified healthcare provider before starting any exercise or diet program.
              </span>
            </div>
          )}
